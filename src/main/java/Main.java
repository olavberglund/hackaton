...
public class Main {
    ...
    Rule rule10 = new Rule(10, "Det opplyses om at personen har egen selvstendig bolig",
            "Det foreligger dokumentasjon på egen selvstendig bolig i tilflytningslandet", "Fortsett registrering");
    Rule rule11 = new Rule(11, "Det opplyses om at personen har egen selvstendig bolig",
            "Det foreligger ingen dokumentasjon på boligen i tilflytningslandet", "Manuell vurdering");
    ...
    Rule rule13 = new Rule(13, "Det opplyses om at personen har dokumentasjon",
            "Det oppgis ingen informasjon om egen selvstendig bolig i tilflytningslandet", "Manuell vurdering");
